 ...
 * @author mirza
 */
public class JenisObatViewFrame extends javax.swing.JFrame {

    /**
     * Creates new form JenisBarangViewFrame
     */
    public JenisObatViewFrame() {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        JenisObatAddFrame jenisBarangAddFrame = new JenisObatAddFrame();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(barisTerpilih >= 0){
            ...
            int stok = Integer.parseInt(m.getValueAt(barisTerpilih, 2).toString());
            int harga = Integer.parseInt(m.getValueAt(barisTerpilih, 3).toString());
            
            JenisObat jb = new JenisObat();
            jb.setId(id);
            jb.setNamaJenisObat(namaJenisBarang);
            jb.setStok(stok);
            jb.setHarga(harga);
            
            JenisObatAddFrame jenisBarangAddFrame = new JenisObatAddFrame(jb);
            jenisBarangAddFrame.setVisible(true);
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        ArrayList<JenisObat> list = jenisObat.read();
        tampilData(list);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ArrayList<JenisObat> list = jenisObat.search(keywords);
        tampilData(list);
    ...
    public void tampilData(ArrayList<JenisObat> list){
        ...
        if(list.size() > 0){
            for (int i = 0; i < list.size(); i++) {
                ...
                row[1] = list.get(i).getNamaJenisObat();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JenisObatViewFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JenisObatViewFrame().setVisible(true);
            }
        });
    }
